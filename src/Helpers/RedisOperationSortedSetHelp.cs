...
namespace NewAge.Redis.Helpers
{
    public partial class RedisOperationHelp
    {
        ...
        public async Task<bool> SortedSetAddAsync<T>(string key, T value, double score)
        {
            ...
            return await redisBase.DoSave(db => db.SortedSetAddAsync(RedisPrefixKey.SortedSetKey + key, value.ToJson(), score));
        }
        /// <summary>
        /// 获取SortedSet的数据
        /// </summary>
        ...
        public async Task<bool> SortedSetRemoveAsync<T>(string key, T value)
        {
            ...
            return await redisBase.DoSave(db => db.SortedSetRemoveAsync(RedisPrefixKey.SortedSetKey + key, value.ToJson()));
        }
    }
}
